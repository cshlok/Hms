          ...
          <CardContent className="space-y-4">
            ...
            <div className="hidden print:block mb-6 text-center">
              ...
              <p>
                ...
                {patientInfo?.patient_last_name} (Admission:{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-b pb-4">
              ...
              <div>
                ...
                <p className="font-medium">
                  {formatDate(dischargeSummary.discharge_date)}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm whitespace-pre-wrap bg-gray-50 p-2 rounded border">
                  {dischargeSummary.discharge_diagnosis}
                </p>
              </div>
              ...
              <div className="pt-2">
                ...
                <p className="font-medium">
                  Dr. {dischargeSummary.doctor_first_name || "N/A"}{" "}
                  {dischargeSummary.doctor_last_name || "N/A"}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        (<Card>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="discharge_diagnosis">
              ...
              <div className="space-y-2">
                <Label htmlFor="treatment_summary">
              ...
              <div className="space-y-2">
                <Label htmlFor="home_care_instructions">
                  Home Care Instructions
                </Label>
                <Textarea
