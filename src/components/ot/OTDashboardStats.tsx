...
export default function OTDashboardStats() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-4">Operation Theatre Dashboard</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loading ? "Loading..." : stats.todayBookings}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loading ? "Loading..." : stats.upcomingBookings}</div>
            <p className="text-xs text-muted-foreground">
              Next 7 days
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loading ? "Loading..." : stats.availableTheatres}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loading ? "Loading..." : stats.pendingChecklists}</div>
            <p className="text-xs text-muted-foreground">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-5 p-4 text-sm items-center border-t">
                  ...
                  <div>OT-2</div>
                  <div><Badge className="bg-blue-500">In Progress</Badge></div>
                </div>
                <div className="grid grid-cols-5 p-4 text-sm items-center border-t">
                  <div>11:00 - 13:30</div>
                ...
                <div className="grid grid-cols-5 p-4 text-sm items-center border-t">
                  ...
                  <div>OT-1</div>
                  <div><Badge className="bg-yellow-500">Scheduled</Badge></div>
                </div>
                <div className="grid grid-cols-5 p-4 text-sm items-center border-t">
                  <div>15:30 - 17:30</div>
