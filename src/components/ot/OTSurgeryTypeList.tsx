          ...
          <Table>
            ...
            <TableBody>
              {surgeryTypes.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={5} className="text-center">No surgery types found.</TableCell>
                </TableRow>
              ) : (
                surgeryTypes.map((type) => (
                  <TableRow key={type.id}>
                    ...
                    <TableCell>{type.estimated_duration_minutes || "N/A"}</TableCell>
                    <TableCell className="max-w-xs truncate">{type.description || "N/A"}</TableCell>
                    <TableCell>
                      <div className="flex space-x-2">
                        <Button variant="outline" size="icon" title="Edit Surgery Type">
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="destructive" size="icon" title="Delete Surgery Type">
