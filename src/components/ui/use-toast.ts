...
function useToast() {
  ...
  if (context === undefined) {
    throw new Error("useToast must be used within a Toaster component or a custom ToastProvider")
  }
