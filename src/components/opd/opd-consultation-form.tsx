  ...
  useEffect(() => {
    ...
    const checkPermissions = async () => {
      ...
      try {
        ...
        const prescribeData: PermissionApiResponse = await prescribeResponse.json();
        const orderData: PermissionApiResponse = await orderResponse.json();
    ...
    const fetchPatientsInQueue = async () => {
      try {
        ...
        if (!response.ok) {
          let errorMessage = "Failed to fetch patients in queue";
          try {
