    ...
    <div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Tabs defaultValue="consultation">
              ...
              <TabsContent value="labTests">
                <Card>
                  <CardContent className="pt-6">
                    {/* Lab tests selection would go here */}
                    <div className="text-center p-4">
                      Lab test ordering functionality will be implemented in the next iteration.
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
      ...
      {!selectedPatient && (
        <div className="text-center p-8 border rounded-md bg-gray-50">
          <p className="text-gray-500">Please select a patient to start consultation</p>
        </div>
      )}
    </div>
  );
