...
export default function CreateRadiologyStudyModal({ onClose, onSubmit, orderId }: CreateRadiologyStudyModalProps) { // FIX: Type props
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const [modalitiesRes, techniciansRes] = await Promise.all([
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await onSubmit({
      ...
      number_of_images: numberOfImages ? parseInt(numberOfImages, 10) : null,
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="accessionNumber" className="text-right">Accession #</Label>
                <Input
                  id="accessionNumber"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="studyDatetime" className="text-right">Study Date/Time *</Label>
                <Input
                  id="studyDatetime"
                  type="datetime-local"
                  value={studyDatetime}
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="modality" className="text-right">Modality</Label>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="seriesDescription" className="text-right">Series Description</Label>
                <Textarea
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="numberOfImages" className="text-right">Number of Images</Label>
                <Input
                  id="numberOfImages"
                  type="number"
                  min="1"
