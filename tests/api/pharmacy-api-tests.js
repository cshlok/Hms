...
describe('Pharmacy API Tests', () => {
  ...
  describe('Medication API', () => {
    ...
    test('GET /api/pharmacy/medications - Get all medications', async () => {
      ...
      const found = data.medications.some(med => med.id === createdMedicationId);
      expect(found).toBe(true);
    });

    // Get medication by ID
    test('GET /api/pharmacy/medications/:id - Get medication by ID', async () => {
      const response = await fetch(`${baseUrl}/api/pharmacy/medications/${createdMedicationId}`);
  ...
  describe('Inventory API', () => {
    ...
    test('GET /api/pharmacy/inventory - Get all inventory batches', async () => {
      ...
      const found = data.inventory.some(item => item.id === createdInventoryId);
      expect(found).toBe(true);
    });

    // Get inventory by ID
    test('GET /api/pharmacy/inventory/:id - Get inventory by ID', async () => {
      const response = await fetch(`${baseUrl}/api/pharmacy/inventory/${createdInventoryId}`);
  ...
  describe('Prescription API', () => {
    ...
    test('GET /api/pharmacy/prescriptions - Get prescriptions with filters', async () => {
      ...
      const response = await fetch(`${baseUrl}/api/pharmacy/prescriptions?status=pending`);
      ...
      const allPending = data.prescriptions.every(p => p.status === 'pending');
  ...
  describe('Dispensing API', () => {
    ...
    test('POST /api/pharmacy/dispensing - Create dispensing record', async () => {
      ...
      const inventoryResponse = await fetch(`${baseUrl}/api/pharmacy/inventory/${createdInventoryId}`);
