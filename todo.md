...
- [ ] **Phase 2: Common Type Mismatches & Unknowns**
    - [x] Fix `TS18046: '...' is of type 'unknown'` errors (e.g., `insertResult.meta`). Provide explicit types for DB results/metadata. (Batch 5: Fixed in appointments, auth/register, billable-items)
